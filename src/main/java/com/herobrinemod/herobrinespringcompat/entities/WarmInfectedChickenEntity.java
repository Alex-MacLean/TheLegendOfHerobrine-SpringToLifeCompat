...
public class WarmInfectedChickenEntity extends InfectedEntity {
    ...
    public WarmInfectedChickenEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    public void tickMovement() {
        ...
        if (!this.getWorld().isClient && this.isAlive() && !this.isBaby() && --this.eggLayTime <= 0) {
            ...
            this.dropItem(STLItems.BROWN_EGG.get()); // Had re-implement the entire infected chicken just to change this. I love Java, OOP, and inheritance. It always makes sense and never has any missing features that it should have being a 30-year-old interpreted language
