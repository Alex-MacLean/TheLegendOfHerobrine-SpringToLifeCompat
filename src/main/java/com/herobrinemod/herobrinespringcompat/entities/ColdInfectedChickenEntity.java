...
public class ColdInfectedChickenEntity extends InfectedEntity {
    ...
    public ColdInfectedChickenEntity(EntityType<? extends HostileEntity> entityType, World world) {
        super(entityType, world);
        this.experiencePoints = 3;
        this.setConversionEntity(STLEntityTypes.COLD_CHICKEN.get());
    }
    ...
    public void tickMovement() {
        ...
        if (!this.getWorld().isClient && this.isAlive() && !this.isBaby() && --this.eggLayTime <= 0) {
            ...
            this.dropItem(STLItems.BLUE_EGG.get()); // Had re-implement the entire infected chicken just to change this. I love Java, OOP, and inheritance. It always makes sense and never has any missing features that it should have being a 30-year-old interpreted language
